...
/**
 * PNT_LOTE_PAGINA — uma página do PDF do lote, vinculada a um operador/técnico.
 * O vínculo (PESSOA_ID/PESSOA_TIPO) é polimórfico sobre PES_OPERADOR/PES_TECNICO,
 * por isso sem FK (mesmo padrão de PES_AUTH_SESSION).
 */
@Entity
