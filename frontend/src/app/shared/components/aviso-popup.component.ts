...
@Component({
  ...
  template: `
    @if (avisos()[0]; as a) {
      <div class="aviso-overlay">
        <div class="card-custom aviso-modal">
          <h2 class="aviso-modal-title">
  ...
  styles: [`
    ...
    .aviso-modal {
      ...
      animation: aviso-in .2s ease-out;
    }
    .aviso-modal-title { margin: 0 0 8px; font-size: 1.2rem; font-weight: 700; color: var(--senado-azul); }
    .aviso-modal-actions { display: flex; justify-content: flex-end; margin-top: 12px; }
    @keyframes aviso-in {
